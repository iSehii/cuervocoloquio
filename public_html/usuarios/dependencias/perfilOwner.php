...
<div class="Edit">
    <form action="" method="POST" enctype="multipart/form-data">
        ...
        <input name="imagen" type="file" id="input-imagen" accept="image/*" onchange="mostrarNombreImagen(); mostrarAlta();">
...
<div class="altaFoto hide" id="altaFoto">
    ...
    <button type="submit" id="guardarBtn" onclick="guardarImagen()">Guardar</button>
        ...
        <tr>
            <td colspan="1" style="background-color: black; border-left: 2px solid aliceblu; border-right: 2px solid aliceblue">
        ...
        echo $UsuarioP->getTiempo($UsuarioP->getFechaModificacion());
                  ...
                  <div>
                    <a href="curriculum/" >
                        <button style="padding: 7px 12px; margin: 2px; border-radius: 2px; background-color: aliceblue; cursor: pointer; border: 2px solid black;">Curriculum</button>
                    </a>
                    </div>
                </div>
                </td>
        ...
        <td colspan="3" class="informacion selectedTab">
            <form action="" method="POST">
                ...
                <div class="FechaNac" id="FechaNacDiv" onclick="FechaNacimiento(); EditarCajas();"
                    ...
                    <div id="Fecha_NacimientoD"> <input name="Fecha_Nacimiento" spellcheck="false" type="date" id="Fecha_NacimientoI"
                            value="<?php echo $UsuarioP->getFechaNacimiento(); ?>"></div><br>
                </div> 
                ...
                <div class="Rol">
                    ...
                    <label id="RolLabel">
                        <?php if ($UsuarioP->getIdRol() == 1) { echo "Administrador"; } else if ($UsuarioP->getIdRol() == 2) { echo "Docente"; } else { echo "Alumno"; } ?>
                    </label>
                </div> 
                <div class="Dia_registro">
                    <label>Estado:</label>
