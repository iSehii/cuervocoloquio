...
if ($_GET['more'] == "igird") {
    ...
    <div class="Contenido">
        <div class="centro categoriasCARRERA">
            <div class="contenedorCat">
                <h1>Ingenieria en Redes Inteligentes y Ciberseguridad</h1>
                ...
                <div class="contenedorCat">
                    ...
                    <div class="Publicaciones">
                        ...
                        if ($Publicaciones->getTotal() >= 5) {
                            $valorP = 5;
                        } else {
                            $valorP = $Publicaciones->getTotal();
                        }
                        for ($i = 0; $i < $valorP; $i++) {
    ...
    ';
                        ...
                        <div style="text-align: right; padding-top: 20px">
                            <a href="panel.php?cat=carreras&f=DSM&more=dsm" style="text-decoration: none">
                                <button
                                    style="padding: 15px 30px; color: black; cursor: pointer; background-color: aliceblue; border: 1px solid blue;">Mostrar
                                    todo</button>
                            </a><br><br>
                        </div>
                        <div class="FinalPublicacion">
                        ...
                        <div class="Usuarios">
                            ...
                            $Usuarios->getUsuarioCarrera(3);
                            if ($Usuarios->getTotalUC() >= 10) {
                                $valorN = 10;
                            } else {
                                $valorN = $Usuarios->getTotalUC();
                            }
                            for ($i = 0; $i < $valorN; $i++) {
                                $Usuarioss = new Usuario();
                                $Usuarioss->setUser($Usuarios->getIdUsuarioG($i));
                                ?>
                                <style>
                                    .User {
                                        margin: 20px;
                                ...
                                <div class="NombreUP User">
                                    <a href=" <?php echo "/usuarios/" . $Usuarioss->getIdUsuario(); ?>" onmouseover="">
                                        <span style="position: relative; padding-top: 15px">
                                            <?php echo '<img src="files/Users/images/' . $Usuarioss->getFoto() . '" width="50px" height="50px" style="margin-bottom: -4px ;border-radius: 3px">'; ?>
                                            <?php echo $Usuarioss->getNombre() . " " . $Usuarioss->getApellidoPaterno(); ?>
                                        </span> <br>
                                        <span>
                                            <?php echo $Usuarios->getNombreGrupo($i) ?>
                                        </span>
                                    </a>
                                </div>
                                <?php
